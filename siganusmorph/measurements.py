...
from .compressed_tail_tl import derive_tail_length_comparison
...
def calculate_measurements(
    ...
    tail_length_comparison = derive_tail_length_comparison(
        keypoints,
        mm_per_pixel,
        sl_mm=sl_final,
        open_projection_endpoint=derived_endpoint,
        open_projection_extension_px=float(caudal_endpoint["extension_px"]),
        open_projection_tl_mm=tl_final,
    )
    ...
    measurements.update(tail_length_comparison)
