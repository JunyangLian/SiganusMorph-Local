...
def save_keypoints_json(
    ...
    payload = {
        ...
        "model_keypoints_raw": metadata_dict.get("preannotation", {}).get("model_keypoints_raw", {}) if isinstance(metadata_dict.get("preannotation"), Mapping) else {},
        "mask_suggestions": metadata_dict.get("preannotation", {}).get("mask_suggestions", {}) if isinstance(metadata_dict.get("preannotation"), Mapping) else {},
        "corrected_keypoints": metadata_dict.get("preannotation", {}).get("corrected_keypoints", formatted_keypoints) if isinstance(metadata_dict.get("preannotation"), Mapping) else formatted_keypoints,
        "keypoint_edit_log": metadata_dict.get("preannotation", {}).get("keypoint_edit_log", []) if isinstance(metadata_dict.get("preannotation"), Mapping) else [],
        "qc_results": metadata_dict.get("preannotation", {}).get("qc_results", {}) if isinstance(metadata_dict.get("preannotation"), Mapping) else {},
